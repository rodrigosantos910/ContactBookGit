...
public class Main {
    ...
    public static final String EXTRA_PHONES = "EP";
    ...
    public static final String EXTRA_PHONES_EXIST = "There are contacts that share phone numbers.";
    public static final String NO_EXTRA_PHONES = "All contacts have different phone numbers.";
    ...
    private static void getExtraPhones(ContactBook cBook) {
        if (cBook.hasExtraPhones()){
            System.out.println(EXTRA_PHONES_EXIST);
        } else {
            System.out.println(NO_EXTRA_PHONES);
        }
    }
